...
{
    public class Route : Entity<int>, IPassivable, IOrderable, IValidable, IUpdatableFrom<Route>
    {
        #region Fields
        ...
        public Route(int id, int siteId, string name, string description, int order, bool isActive, string photoUrl)
            : this()
        {
            Id = id;
            SiteId = siteId;
        ...
        public void UpdateFrom(Route actualEntity)
        {
