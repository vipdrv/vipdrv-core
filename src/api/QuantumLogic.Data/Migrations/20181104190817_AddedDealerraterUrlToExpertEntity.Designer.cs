...
namespace QuantumLogic.Data.Migrations
{
    ...
    [Migration("20181104190817_AddedDealerraterUrlToExpertEntity")]
    partial class AddedDealerraterUrlToExpertEntity
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("QuantumLogic.Core.Domain.Entities.WidgetModule.Expert", b =>
                {
                    ...
                    b.Property<string>("DealerraterUrl");
                    ...
                    b.Property<bool>("IsPartOfTeamCPO");

                    b.Property<bool>("IsPartOfTeamNewCars");

                    b.Property<bool>("IsPartOfTeamUsedCars");
            ...
            modelBuilder.Entity("QuantumLogic.Core.Domain.Entities.WidgetModule.Site", b =>
                {
                    ...
                    b.Property<bool>("AvailableTestDriveFromHome");

                    b.Property<string>("BeautyId");

                    b.Property<string>("CrmProvider");
                    ...
                    b.Property<bool>("InjectButtonToSidebar");

                    b.Property<bool>("InjectButtonToSrp");

                    b.Property<bool>("InjectButtonToVdp");

                    b.Property<bool>("InjectWidgetToSaw");

                    b.Property<int>("MaxVehicleDeliveryDistance");

                    b.Property<string>("Name");

                    b.Property<int>("NewVehiclesCount");

                    b.Property<string>("NotificationContacts");

                    b.Property<bool>("SendEmailNotificationsToCustomer");

                    b.Property<bool>("ShuffleExperts");

                    b.Property<string>("SiteProvider");

                    b.Property<string>("Url");

                    b.Property<int>("UsedVehiclesCount");

                    b.Property<int>("UserId");

                    b.Property<string>("WidgetAsSeparatePageUrl");
            ...
            modelBuilder.Entity("QuantumLogic.Core.Domain.Entities.WidgetModule.Step", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("QuantumLogic.Core.Domain.Entities.WidgetModule.WidgetEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
