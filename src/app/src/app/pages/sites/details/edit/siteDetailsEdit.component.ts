...
export class SiteDetailsEditComponent {
    ...
    // is available test drive from home
    ...
    // import path
    protected isImportRelativeFtpPathInputDisabled(): boolean {
        return this.isReadOnly;
    }
    protected isImportRelativeFtpPathValid(): boolean {
        return this.siteValidationService.isImportRelativeFtpPathValid(this.entity);
    }
    protected getInvalidImportRelativeFtpPathMessageKey(): string {
        return this.siteValidationService.getInvalidImportRelativeFtpPathMessageKey(this.entity);
    }
    // shuffle experts
    protected isShuffleExpertsInputDisabled(): boolean {
        return this.isReadOnly;
    }
    protected isShuffleExpertsValid(): boolean {
        return this.siteValidationService.isShuffleExpertsValid(this.entity);
    }
    protected getShuffleExpertsInvalidMessageKey(): string {
        return this.siteValidationService.getInvalidShuffleExpertsMessageKey(this.entity);
    }
}
