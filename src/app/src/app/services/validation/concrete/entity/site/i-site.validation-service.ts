...
export interface ISiteValidationService extends IValidationService<SiteEntity> {
    ...
    isImportRelativeFtpPathValid(site: SiteEntity): boolean;
    isShuffleExpertsValid(site: SiteEntity): boolean;
    ...
    getInvalidImportRelativeFtpPathMessageKey(site: SiteEntity): string;
    getInvalidShuffleExpertsMessageKey(site: SiteEntity): string;
}