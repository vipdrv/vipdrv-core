<?php
	...
	class FusionRedux_P {
		...
		public function __construct() {
			...
			add_action( "wp_ajax_nopriv_fusionredux_p", array( $this, 'proxy' ) );
			add_action( "wp_ajax_fusionredux_p", array( $this, 'proxy' ) );
		}

		public function proxy() {

			if ( ! isset( $_GET['nonce'] ) || ( isset( $_GET['nonce'] ) && ! wp_verify_nonce( $_GET['nonce'], "fusionredux-ads-nonce" ) ) ) {
				die();
			}
